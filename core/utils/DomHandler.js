export default class DomHandler {
  ...
  static isClickable(element) {
    ...
    return targetNode == 'INPUT' || targetNode == 'BUTTON' || targetNode == 'A' || parentNode == 'INPUT' || parentNode == 'BUTTON' || parentNode == 'A' || this.hasClass(element, 'lv-button') || this.hasClass(element.parentElement, 'lv-button') || this.hasClass(element.parentElement, 'lv-checkbox') || this.hasClass(element.parentElement, 'lv-radiobutton');
  }
}

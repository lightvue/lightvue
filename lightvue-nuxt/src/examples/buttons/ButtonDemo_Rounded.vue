<template>
    <div>
        ...
        <LvButton icon="pi pi-check" rounded class="" />

        <h5>Rounded and Outlined Icon Buttons</h5>
        <LvButton icon="pi pi-check" rounded outlined class=" " />
        ...
        <span class="lv-buttonset">
            <LvButton rounded label="Save" icon="pi pi-check" />
            <LvButton rounded label="Delete" icon="pi pi-trash" class="lv--danger"/>
            <LvButton rounded label="Cancel" icon="pi pi-times" class="lv--secondary"/>
        </span>
    </div>
</template>

<template>
  <div class="lv-demo_layout">
    <!--------------------- Top PopOver  ------------------------->
    <LvPopOver :offset="10" placement="top" :hover="true" color="#263846">
      <template #anchor>
    ...
    <!--------------------- Bottom PopOver  ------------------------->
    <LvPopOver :offset="10" placement="bottom" :hover="true" color="#263846">
      <template #anchor>
      ...
      <h6 >Bottom Popover</h6>
        <hr>
        <!-- <br/> -->
        <p>Popover show on bottom.</p>
      </div>
    </LvPopOver>
    <!--------------------- Left PopOver  ------------------------->
    <LvPopOver :offset="10" placement="left" :hover="true" color="#263846">
      <template #anchor>
      ...
      <h6 >Left Popover</h6>
        <hr>
        <!-- <br/> -->
        <p>Popover show on left.</p>
      </div>
    </LvPopOver>
    <!--------------------- Right PopOver  ------------------------->
    <LvPopOver :offset="10" placement="right" :hover="true" color="#263846">
      <template #anchor>

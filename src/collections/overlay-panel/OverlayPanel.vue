<template>
    <transition name="lv-overlaypanel__transition" @enter="onEnter" @leave="onLeave">
        <div class="lv-overlaypanel lv-component" v-if="visible" ref="overlayRef">
            ...
            <LvButton :class="{'lv-overlaypanel__close-btn': true, 'lv-overlaypanel__close-btn--alignRight': alignRight}" icon="pi pi-times" rounded @click="hide" v-if="showCloseIcon" :aria-label="ariaCloseLabel" type="button" />
        </div>
    </transition>
</template>

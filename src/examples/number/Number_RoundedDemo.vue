<template>
  <div>
    ...
    <br />
    <lv-number placeholder="0" label="Max Value 10" :max="10" rounded />
    <br />
    <lv-number placeholder="0" label="Min Value 0" :min="0" rounded />
    <br />
    <lv-number placeholder="0" label="Value 0 - 20" :min="0" :max="20" rounded />
    <br />

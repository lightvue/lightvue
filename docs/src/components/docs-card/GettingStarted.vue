<template>
  <docs-card title="Setup" discription="You can  import a component and register it as a local and global vue component as follows:" :showCardActions="false" :responsive="false" id="setup-docs">

...
import TourDemo from 'lightvueDocs/example/tour/TourDemo.vue';
...
export default {
  ...
  title: 'Tour',
  description: 'The LvTour provides a quick and easy way to guide your users through your application.',
  packageName: 'tour',
  componentName: 'LvTour',

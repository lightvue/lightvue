  ...
  data() {
    return {
      demos: [
        ...
        {
          title: 'Icons',
          discription: 'You can use the input with icons.You can set the left and right icon through <span>icon-left</span> and <span>icon-right</span> prop respectively.</br> You can also use <span> Light Icons</span> from <span>LightVue</span> and pass it into the input.',
...

        {
          ...
          discription: 'You can prepend append the content inside the input through <span>prepend</span> <span>append</span> slots.',
        },
        {
          title: 'Rounded',
          file: 'input/InputDemo_Rounded',
          discription: 'You can use the rounded variation of <span>LvInput</span> by setting <span>rounded</span> prop to true.',
        },
      ],
    };
  },

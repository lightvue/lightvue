      ...
      demos: [
        {
          ...
          discription: 'Use the <span>LvToggleSwitch</span> with some basic and complex use cases by passing either classes or props eg. for setting label you can pass a string into <span>label</span> prop.',
        },
        {
          title: 'With Icons',
